<template>
  <div class="pay">
    ...
    <div class="btn-box">
      <van-button type="primary" block round color="#0b34ba" @click="payBox"
        >立即结算</van-button
      >
    </div>
      ...
      this.axios({
        ...
        .then((res) => {
          ...
          if (res.data.code == 700) {
            ...
            // 打印订单商品数据
            console.log("该订单中商品数据 =>",this.products);
            // 获取当前时间
            this.productInfo.date = new Date().toISOString();
            console.log(this.productInfo.date);
          } else {
